...
import argparse
import wandb
from lgdata import  MyCustomDataset
from torch.utils.tensorboard import SummaryWriter
import torch.nn.functional as F
from Combine_AE import Combine_AE
import Combine_AE_dilate
from Combine_AE_dilate import Combine_AE_dilate
def get_args_parser():

    parser = argparse.ArgumentParser(description='Deep Face Drawing: Train Stage')
    parser.add_argument('--dataset', type=str, default='.../datasets/LG-BBDM-2/train/B/')
    parser.add_argument('--log_dir', type=str, default='./lg_ae/outputs/')
    ...
    parser.add_argument('--date', type=str, default='0628')
...
def main():
    ...
    dataset = MyCustomDataset("/home/nwu-kiki/mydisk/pycharmprojects/BBDM+Trasformer+light/BBDM-main/LG-BBDM-2/train/A")
    ...
    for epoch in range(args.epochs):
        ...
        for i, sketches in enumerate(train_loader):
            ...
            #         target = sketches
                ...
                # recon_loss= F.mse_loss(output[0], target)
                kld_loss = output[1].mean()
