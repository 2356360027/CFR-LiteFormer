...
def define_part_encoder(model='mouth', norm='instance', input_nc=3, latent_dim=512):
...
def define_part_decoder(model='mouth', norm='instance', output_nc=3, latent_dim=512):
    norm_layer = get_norm_layer(norm_type=norm)
